...
class NetworkDelayDetector(app_manager.RyuApp):
    ...
    def echo_reply_handler(self, ev):
        ...
        timezz = self.times
        self.echo_latency[ev.msg.datapath.id] = now_timestamp-timezz
    ...
    def get_delay(self, src, dst):
        ...
        try:
            ...
            # print("src :",src )
            # print("src latency:",src_latency*1000 )
            #print("src delay:",fwd_delay*1000 )
            # print("dst :",dst )
            # print("dst latency:",dst_latency*1000 )
            #print("dst delay:",re_delay*1000 )

            delay = (fwd_delay + re_delay - src_latency - dst_latency)/2
            #delay = (fwd_delay + re_delay )/2
            return max(delay, 0)
        except:
            return float('inf')

    def _save_lldp_delay(self, src, dst, lldpdelay):
        try:
